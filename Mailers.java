...
public class Mailers {
  ...
  public void vName(String vname){
      String[][] allAccounts = { 
        ...
        // BATCH-2
        {"9", "ID: \t\t GA-2016-2018-1", "SENT: \t\t 6/10/2020", "PIECES: \t 12,413", "TRAY(1'): \t 16", "TRAY(2'): \t 11", "CHECK#: \t 6186", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-2"},
        {"10", "ID: \t\t GA-2016-2018-2", "SENT: \t\t 6/12/2020", "PIECES: \t 12,398", "TRAY(1'): \t 11", "TRAY(2'): \t 12", "CHECK#: \t 6187", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-2"},
        {"11", "ID: \t\t GA-2016-2018-3", "SENT: \t\t 6/17/2020", "PIECES: \t 11,881", "TRAY(1'): \t 10", "TRAY(2'): \t 12", "CHECK#: \t 6203", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-2"},
        {"12", "ID: \t\t GA-2016-2018-6", "SENT: \t\t 6/24/2020", "PIECES: \t 11,684", "TRAY(1'): \t 9", "TRAY(2'): \t 12", "CHECK#: \t 6211", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-2"},
        {"13", "ID: \t\t GA-OR-2016-2018-7", "SENT: \t\t 6/26/2020", "PIECES: \t 9,425", "TRAY(1'): \t 6", "TRAY(2'): \t 13", "CHECK#: \t 6212", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-2"},
        {"14", "ID: \t\t OR-VA-2016-2018-10", "SENT: \t\t 7/1/2020", "PIECES: \t 10,588", "TRAY(1'): \t 4", "TRAY(2'): \t 13", "CHECK#: \t 6213", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-2"},
        // BATCH-3
        {"15", "ID: \t\t NC-2015-2018-1", "SENT: \t\t 7/3/2020", "PIECES: \t 12,462", "TRAY(1'): \t 8", "TRAY(2'): \t 13", "CHECK#: \t 6243", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-3"},
        {"16", "ID: \t\t NC-MD-2015-2018-2", "SENT: \t\t 7/8/2020", "PIECES: \t 12,281", "TRAY(1'): \t 12", "TRAY(2'): \t 12", "CHECK#: \t 6245", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-3"},
        {"17", "ID: \t\t MD-CO-2015-2018-3", "SENT: \t\t 7/15/2020", "PIECES: \t 12,038", "TRAY(1'): \t 9", "TRAY(2'): \t 13", "CHECK#: \t 6246", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-3"},
        {"18", "ID: \t\t CO-CA-2015-2018-4", "SENT: \t\t 7/17/2020", "PIECES: \t 12,325", "TRAY(1'): \t 11", "TRAY(2'): \t 12", "CHECK#: \t 6267", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-3"},
        {"19", "ID: \t\t CA-2015-2018-5", "SENT: \t\t 7/22/2020", "PIECES: \t 12,406", "TRAY(1'): \t 11", "TRAY(2'): \t 12", "CHECK#: \t 6272", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-3"},
        {"20", "ID: \t\t CA-2015-2018-6", "SENT: \t\t 8/12/2020", "PIECES: \t 12,518", "TRAY(1'): \t 9", "TRAY(2'): \t 14", "CHECK#: \t 6301", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-3"},
        {"21", "ID: \t\t CA-2015-2018-7", "SENT: \t\t 8/19/2020", "PIECES: \t 12,655", "TRAY(1'): \t 9", "TRAY(2'): \t 14", "CHECK#: \t 6324", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-3"},
        {"22", "ID: \t\t CA-2015-2018-8", "SENT: \t\t 8/28/2020", "PIECES: \t 12,516", "TRAY(1'): \t 9", "TRAY(2'): \t 14", "CHECK#: \t 6332", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-3"},
        {"23", "ID: \t\t CA-2015-2018-9", "SENT: \t\t 9/2/2020", "PIECES: \t 12,360", "TRAY(1'): \t 9", "TRAY(2'): \t 14", "CHECK#: \t 6368", "SAP: \t\t ", "STATUS: \t Problem with USPS", "BATCH-3"},
        {"24", "ID: \t\t CA-2015-2018-10", "SENT: \t\t 9/16/2020", "PIECES: \t 12,317", "TRAY(1'): \t 11", "TRAY(2'): \t 12", "CHECK#: \t ", "SAP: \t\t ", "STATUS: \t printing...", "BATCH-3"},
        ...
        // BATCH-4
        {"29", "ID: \t\t MN-MO_1518_1", "SENT: \t\t 7/24/2020", "PIECES: \t 9,800", "TRAY(1'): \t 4", "TRAY(2'): \t 11", "CHECK#: \t 6274", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-4"},
        {"30", "ID: \t\t MO-NJ_1518_2", "SENT: \t\t 7/29/2020", "PIECES: \t 9,771", "TRAY(1'): \t 7", "TRAY(2'): \t 10", "CHECK#: \t 6275", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-4"},
        {"31", "ID: \t\t NJ_1518_3", "SENT: \t\t 8/5/2020", "PIECES: \t 9,853", "TRAY(1'): \t 4", "TRAY(2'): \t 11", "CHECK#: \t 6299", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-4"},
        {"32", "ID: \t\t NJ-NY_1518_4", "SENT: \t\t 8/7/2020", "PIECES: \t 9,593", "TRAY(1'): \t 10", "TRAY(2'): \t 9", "CHECK#: \t 6300", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-4"},
        {"33", "ID: \t\t NY_1518_5", "SENT: \t\t 8/13/2020", "PIECES: \t 9,438", "TRAY(1'): \t 8", "TRAY(2'): \t 10", "CHECK#: \t 6303", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-4"},
        {"34", "ID: \t\t NY_1518_6", "SENT: \t\t 8/26/2020", "PIECES: \t 10,495", "TRAY(1'): \t 6", "TRAY(2'): \t 12", "CHECK#: \t 6330", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-4"},
        // BATCH-5
        {"35", "ID: \t\t MI-1518_1", "SENT: \t\t 9/2/2020", "PIECES: \t 8,770", "TRAY(1'): \t 5", "TRAY(2'): \t 9", "CHECK#: \t 6367", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-5"},
        {"36", "ID: \t\t MI-NE-NM-NV-1518_2", "SENT: \t\t 9/4/2020", "PIECES: \t 8,742", "TRAY(1'): \t 9", "TRAY(2'): \t 9", "CHECK#: \t 6369", "SAP: \t\t ", "STATUS: \t Shipped", "BATCH-5"},
        {"37", "ID: \t\t NV-SC-1518_3", "SENT: \t\t 8/14/2020", "PIECES: \t 8,671", "TRAY(1'): \t 15", "TRAY(2'): \t 7", "CHECK#: \t 6322", "SAP: \t\t YES", "STATUS: \t Shipped", "BATCH-5"},
        {"38", "ID: \t\t SC-UT-1518_4", "SENT: \t\t 9/11/2020", "PIECES: \t 8,666", "TRAY(1'): \t 6", "TRAY(2'): \t 8", "CHECK#: \t ", "SAP: \t\t YES", "STATUS: \t Printed", "BATCH-5"},
        // BATCH-6
    ...
    for (int i = 0; i < allAccounts.length; i++){    
      ...
      if (vname.equals("HELP")){
        ...
        System.out.println("\t'date'<Enter>\t\t\t\tsearch by sent Date \t \\\\ example: 9/4/2020");
        System.out.println("\t'b'(+Batch number)+':status'<Enter>\tfor shipment status \t \\\\ example: b2:status");
        System.out.println("\t'b'(+Batch number)+':sap'<Enter>\tfor SAP status \t\t \\\\ example: b2:sap");
