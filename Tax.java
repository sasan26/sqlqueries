...
public class Tax {
    ...
    public void vName(String vname){
        String[][] allAccounts = { 
          ...
          {"IL", "Illinois", "10/06/2020", "Jan 2021", "", "$0.00", "NOPAYMENT"},
          ...
          {"LA", "Louisiana", "12/01/2020", "12/30/2020", "", "$20.00 \t\t Late Fee", "NOPAYMENT"},
          ...
          {"MI", "Michigan", "12/31/2020", "Jan 2021", "", "$0.00", "NOPAYMENT"},
          ...
          {"NE", "Nebraska", "10/06/2020", "Quarterly", "", "$0.00", "NOPAYMENT"},
          ...
          {"NY", "New York", "10/01/2020", "Quarterly", "", "$0.00", "NOPAYMENT"},
          {"NC", "North Carolina", "11/31/2020", "Monthly", "", "$0.00", "NOPAYMENT"},
          {"ND", "North Dakota", "--/--/----", "", "Wrong login credential", "$0.00", "NOPAYMENT"},
          {"OH", "Ohio", "10/31/2020", "Monthly", "", "$0.00", "NOPAYMENT"},
          {"OK", "Oklahoma", "--/--/----", "", "Wrong login credential", "$0.00", "NOPAYMENT"},
          {"OR", "Oregon", "06/11/2020", "", "Wrong login credential", "$0.00", "NOPAYMENT"},
