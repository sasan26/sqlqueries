...
DECLARE @Circuit_Quarterly INT = 6 
DECLARE @ATD_Retai_Reward INT = 0
DECLARE @Nitto_ATD_STH DECIMAL(18,2) = 1.75

-- Kumho   (Level3 - 200 units)
DECLARE @ATD_Retail_Rewards INT = 0 
DECLARE @Quarterly_Volume_Bonus INT = 1
DECLARE @FUEL_Quarterly_Line_Rebate INT = 0
DECLARE @FUEL_Hi_Octane_Bonus_18 INT = 0
DECLARE @Kumho_ATD_STH DECIMAL(18,2) = 1.75

--Falken	(400 units)
DECLARE @Fanatic_Rebate INT = 6
DECLARE @AT_Trail_Promo INT = 0
DECLARE @Q4_Promo INT = 0
...
DECLARE @GOLD_Reward INT = 0
DECLARE @Annual_Volume_Bonus INT = 5
DECLARE @Q4_Gold_Promo INT = 0
DECLARE @Max_Retail_Rewards INT = 0
...
DECLARE @Bridgestone_Rebate INT = 6
DECLARE @Bridgestone_Plus INT = 5
DECLARE @Bridgestone_Annual INT = 0
DECLARE @Bridgestone_G3xpress INT = 0

-- Firestone   (Plus:Level2 - 300 units, Annual:Level3 - 3000 units)
DECLARE @Firestone_Rebate INT = 4
DECLARE @Firestone_Plus INT = 3
DECLARE @Firestone_Annual INT = 0
DECLARE @Firestone_G3xpress INT = 0

-- Fuzion   (Annual:Level1 - 1200 units)
DECLARE @Fuzion_Rebate INT = 2
DECLARE @Fuzion_Plus INT = 2
DECLARE @Fuzion_Annual INT = 0
DECLARE @Fuzion_G3xpress INT = 0

-- Goodyear   (Tire4 - 800 unit)
DECLARE @Goodyear_Rebate INT = 0
DECLARE @Goodyear_Plus INT = 5
DECLARE @Goodyear_Annual INT = 0
DECLARE @Goodyear_G3xpress INT = 13

-- Kelley   (Tire2 - 200 units)
DECLARE @Kelley_Rebate INT = 0
DECLARE @Kelley_Plus INT = 0
DECLARE @Kelley_Annual INT = 0
DECLARE @Kelley_G3xpress INT = 5

-- Dunlop  (Tire2 - 200 units)
DECLARE @Dunlop_Rebate INT = 0
DECLARE @Dunlop_Plus INT = 3
DECLARE @Dunlop_Annual INT = 0
DECLARE @Dunlop_G3xpress INT = 3
...
EXEC CalNetPrice @Bridgestone_Rebate, @Bridgestone_Plus, @Bridgestone_Annual, @Bridgestone_G3xpress, @Firestone_Rebate, @Firestone_Plus, @Firestone_Annual, @Firestone_G3xpress,
